...
@section('content')
    <div class="pt-[120px] pb-[40px] flex items-center justify-center container mx-auto ">
        <div class="w-[550px] mt-12">
            <h2 class="text-3xl font-bold text-primary-orange">{{ __('Learn, Develop & Launch Your Skills') }}</h2>
            <h3 class="text-2xl text-neutral-gray mt-2 mb-4">{{ __('Join our platform and start your journey today') }}</h3>
            <a href="{{ route('courses.index') }}"
               class="inline-block px-6 py-2 font-bold bg-primary-orange hover:bg-secondary-orange active:bg-yellow text-white text-xl rounded-full ">
                {{ __('Browse Courses') }}
            </a>
        </div>
    ...
    <div class=" py-[40px]" id="courses">
        <div class="container mx-auto">
            ...
            <ul class="flex gap-x-2 py-5 text-xl text-[#333]">
                <li><a href="#">{{ __('Latest Courses -') }}</a></li>
                <li><a href="#">{{ __('Best Sellers -') }}</a></li>
                <li><a href="#">{{ __('Free Courses') }}</a></li>
            </ul>
